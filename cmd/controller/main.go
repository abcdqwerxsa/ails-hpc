...
func init() {
	...
	utilruntime.Must(ailsv1alpha1.AddToScheme(scheme))
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "ails-hpc-controller-lock",
	})
	if err != nil {
	...
	setupLog.Info("starting ails-hpc-controller manager")
